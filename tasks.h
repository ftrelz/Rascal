...
******************************************************************************/
#define TASK_NAV_P                              OSTCBP(1)
//#define TASK_I2C_P                              OSTCBP(2)
#define TASK_EXTERNALCMDS_P                     OSTCBP(2)
//#define TASK_EXTERNALCMDSMHX_P                  OSTCBP(4)
//#define TASK_MHXPOWER		                    OSTCBP(5)
//#define TASK_BEACON_P							OSTCBP(6)
//#define TASK_VAND_P								OSTCBP(7)
//#define TASK_SCHEDULER_P						OSTCBP(4)
//#define TASK_MISSIONCLOCK_P						OSTCBP(5)
...
#define TASK_ESTIMATOR_P                        OSTCBP(3)
#define TASK_IMAGER_P                           OSTCBP(4)
